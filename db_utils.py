...
class RDSDatabaseConnector:
    ...
    def createDataframe(self, engine):
        self.connector()
        loan_payments = pd.read_sql_table('loan_payments', engine)
        return loan_payments

    def saveData(self, loan_payments):
        self.createDataframe
        loan_payments.to_csv(r'C:\Users\ljsay\Documents\GitHub\exploratory-data-analysis---customer-loans-in-finance\loanpayments.csv')    
